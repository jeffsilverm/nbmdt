...
colors[ErrorLevels.DOWN_DEPENDENCY] = ['black', 'on_cyan']          # Down because something this thing is dependent
# on is down
colors[ErrorLevels.DOWN_ACKNOWLEDGED] = ['black', 'on_magenta']     # Down, but a human knows of it
colors[ErrorLevels.CHANGED] = ['white', 'on_black']                 # Up, but differrent from what the sysadmin set
# it as
colors[ErrorLevels.OTHER] = ['black', 'on_grey']                    # Something is amis
